...
/*
 ...
 This test deliberately only occupies half the screen (320 x 240 pixel area)
 so performance can be compared with other 320 x 240 display tests.

 The individual random pixel plot test has been changed as it took far longer
 to calculate 30,000 random numbers than to plot the pixels!
...
// Clear the screen and draw the frame
  ...
  myGLCD.drawCentreString("* TFT_HX8357 *", 160, 4, 1);
...
// Draw some random rounded rectangles
 ...
 for (int i=0; i<100; i++)
  ...
  myGLCD.fillRect(0, 0, 319, 240, TFT_BLUE);
