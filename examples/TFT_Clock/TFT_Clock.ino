/*
  ...
  use of some of the drawing commands with the HX8357 library.
...
void setup(void) {
  ...
  // Draw clock face
  xpos = tft.width() / 2; // Work out the x coord for the centre of the screen
  tft.fillCircle(xpos, 120, 118, TFT_GREEN);
  ...
  tft.drawCentreString("Time flies", xpos, 260, 4);
